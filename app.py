...
if len(st.session_state.chat) == 0:
    if resume_text:
        # Personalized question based on resume (simplified example)
        first_q = f"Can you tell me about your experience with {resume_text.split()[0]}?"
    else:
...
if prompt:
    ...
    # Next question
    if resume_text:
        next_q = f"Can you elaborate on your project or skill mentioned in your resume?"
    else:
...
st.markdown("---")
st.markdown(
    "<p style='text-align:center;color:gray;'>🚀 Built with ❤ by Team TechTitans | AI Hackathon 2025</p>",
    unsafe_allow_html=True
)